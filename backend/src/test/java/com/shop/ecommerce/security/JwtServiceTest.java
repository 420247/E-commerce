 ...
 *
 * <p>We use ReflectionTestUtils to inject @Value fields directly without starting the Spring
 * context — keeps tests fast (no ApplicationContext).
 *
 * <p>The secret key below is safe for tests only — never use in production.
 */
class JwtServiceTest {
  ...
  void generateRefreshToken_containsCorrectEmail() {
    ...
    assertThat(jwtService.extractUsername(refreshToken)).isEqualTo("alice@example.com");
  }
