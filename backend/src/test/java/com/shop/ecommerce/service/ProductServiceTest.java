...
class ProductServiceTest {
  ...
  void getProducts_priceRange_returnsProductsInRange() {
    ...
    when(productRepository.findWithFilters(null, min, max, null)).thenReturn(List.of(book));
  ...
  void getProducts_noMatches_returnsEmptyList() {
    when(productRepository.findWithFilters(any(), any(), any(), any())).thenReturn(List.of());
