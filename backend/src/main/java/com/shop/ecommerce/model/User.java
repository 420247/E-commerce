...
/**
 * User entity mapped to the "users" table in the database. Implements UserDetails to integrate with
...
public class User implements UserDetails {
  ...
  /**
   * Returns the authorities (roles) granted to the user. Spring Security uses this to check
   * permissions.
   */
  @Override
