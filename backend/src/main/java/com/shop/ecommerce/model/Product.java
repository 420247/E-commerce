...
/**
 * Product entity mapped to the "products" table in the database.
...
public class Product {
    ...
    @Column(nullable = false, precision = 10, scale = 2) // precision=10 total digits, scale=2 decimal places e.g. 99999999.99
     ...
     * @PrePersist runs just before INSERT — no need to set it manually.
     */
    @PrePersist
