...
/**
 * REST controller for AI-powered product search. Endpoint is public — no JWT required. Base URL:
 * /api/ai
 */
@RestController
...
public class AiSearchController {
  ...
  /**
   * POST /api/ai/search Accepts natural language query, returns matching products + explanation.
   *
   * <p>Request body: { "query": "cheap phone under 500 euros" } Response: { "products": [...],
   * "explanation": "..." }
   */
  @PostMapping("/search")
