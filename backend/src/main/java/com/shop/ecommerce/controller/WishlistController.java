 ...
 * All endpoints require JWT token — configured in SecurityConfig (.anyRequest().authenticated())
 * Base URL: /api/wishlist
 *
 * @AuthenticationPrincipal — Spring Security injects the currently authenticated User object
 *                            extracted from the JWT token automatically by JwtAuthenticationFilter
 */
@RestController
...
public class WishlistController {
     ...
     * Called on page load — Angular fetches wishlist after login.
     */
    @GetMapping
     ...
     * Returns the created WishlistItem with 200 OK.
     *
     * @PathVariable — extracts productId from URL e.g. /api/wishlist/3
     */
