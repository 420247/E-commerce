...
/**
 * Service handling user registration and login logic. Generates JWT tokens after successful
 * authentication.
 */
@Service
...
public class AuthService {
  ...
  /**
   * Registers a new user in the system. Hashes the password and saves user to database. Returns JWT
   * tokens so user is immediately logged in after registration.
   *
  ...
  /**
   * Authenticates an existing user. Spring Security verifies email and password automatically.
