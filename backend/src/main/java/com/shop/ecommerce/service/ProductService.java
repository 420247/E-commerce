 ...
 * Handles fetching and filtering products from the database.
 *
 * @Service — marks class as a Spring service bean (singleton, managed by Spring)
...
public class ProductService {
    ...
    /**
     * Returns all products, optionally filtered by category, price range and rating.
     * All parameters are optional — null means "no filter applied".
     *
     * Example: getProducts("electronics", null, new BigDecimal("500"), new BigDecimal("4.0"))
     ...
     * Throws RuntimeException with 404-friendly message if product not found.
     *
